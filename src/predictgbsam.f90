subroutine predictgbsam(xobs,xmin,xmax,nobs,nfun,nbasis,nint,fmodel,fpm,smcmc,&
...
real(8),intent(in) :: thetag(nbasis+1,nfun,smcmc),omegag(smcmc,nfun)
real(8),intent(in) :: alphag(smcmc,nfun),psig(smcmc,nfun)
